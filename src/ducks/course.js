...
const SET_COURSE_TITLE = 'planck/course/SET_COURSE_TITLE'
const SET_COURSE_DESCRIPTION = 'planck/course/SET_COURSE_DESCRIPTION'
const SET_COURSE_ICON = 'planck/course/SET_COURSE_ICON'
const MOVE_LESSON = 'planck/course/MOVE_SLIDE'
const DELETE_LESSON = 'planck/course/DELETE_SLIDE'
const ADD_LESSON = 'planck/course/ADD_SLIDE'
const ADD_TAG = 'planck/course/ADD_TAG'
const REMOVE_TAG = 'planck/course/REMOVE_TAG'
...
const initialState = Immutable.fromJS(course)

const actions = {
  [SET_COURSE_TITLE](state, action) {
    return state.set('title', action.payload.newTitle)
  },
  [SET_COURSE_DESCRIPTION](state, action) {
    return state.set('description', action.payload.newDescription)
  },
  [SET_COURSE_ICON](state, action) {
...
export function setCourseTitle(newTitle) {
  return {
    type: SET_COURSE_TITLE, payload: { newTitle },
  }
}

export function setCourseDescription(newDescription) {
  return {
    type: SET_COURSE_DESCRIPTION, payload: { newDescription },
  }
}

export function setCourseIcon(newIcon) {
  return {
    type: SET_COURSE_ICON, payload: { newIcon },
  }
}
